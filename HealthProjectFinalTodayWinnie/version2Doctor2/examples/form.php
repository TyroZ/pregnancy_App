      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="#pablo"> Paient Information</a>
          </div>
		    ...
		    echo " GENERAL INFORMATION";     
                   echo " <div class='row'> ";
                     ...
                     echo " <div class='col-md-3'>";
                      echo "  <div class='form-group'> ";
                      echo "    <label class='bmd-label-floating'><a href='healthprofile.php?P_ID=" . $row['P_ID']. " '> " . $row['P_ID']. " </a></label> ";
...
echo "</form>";
		...
		$result5 = mysqli_query($connect,"SELECT * FROM INFANT_FEEDING_COUNSELLING where P_ID=" . $txt); 
		   ...
		   while($row = mysqli_fetch_array($result2)){      
		    ...
		    echo " <form  method='GET' enctype='multipart/form-data'  enctype='multipart/form-data '> ";
		        echo "<div class='table-responsive'>";     
		     echo "<h5> HEALTH PROFILE</h5>"; 
		     echo "<caption> PMTCT </caption>"; 
		     echo "<table border='1' cellpadding='0' cellspacing='0'  >";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result1'>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result11'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control' name='result2'>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result22'>";
            echo "<option value='POSITIVE'>POSITIVE</option>";
            echo "<option value='NEGATIVE'>NEGATIVE</option>";
            echo  "</div>";
            echo "</select>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result3'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result33'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result4'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result44'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result5'>";
            echo "<option value='POSITIVE'>EXCELLENT</option>";
            echo "<option value='POSITIVE'>GOOD</option>";
            echo "<option value='NEGATIVE'>BAD</option>";
            echo  "</div>";
            ...
            echo "<div class='col-md-12'>";
            echo "<div class='form-group'>";
            echo "<select type='text' class='form-control name='result55'>";
            echo "<option  value='POSITIVE'>EXCELLENT</option>";
            echo "<option  value='POSITIVE'>GOOD</option>";
            echo "<option  value='NEGATIVE'>BAD</option>";
            echo  "</div>";
...
echo "</form>";
		    ...
		    echo " <form  method='post' enctype='multipart/form-data'  enctype='multipart/form-data '> ";
		        echo "<div class='table-responsive'>";     
		     echo "<caption> PMTCT DRUG INTERVENTIONS</caption>"; 
		     echo "<table border='1' cellpadding='0' cellspacing='0'  >";
...
echo "</form>";
	        ...
	        <?php
               ...
               if ($_SERVER["REQUEST_METHOD"] == "GET")
              {
                ...
                $date11=$_GET["date11"];
                $result11=$_GET["result11"];
                $date2=$_GET["date2"];
                $result2=$_GET["result2"];
                $date22=$_GET["date22"];;
                $result22=$_GET["result22"];
                $date3=$_GET["date3"];
                $result3=$_GET["result3"];
                $date33=$_GET["date33"];
                $result33=$_GET["result33"];
                $date4=$_GET["date4"];
                $result4=$_GET["result4"];
                $date44=$_GET["date44"];
                $result44=$_GET["result44"];
                $date5=$_GET["date5"];
                $result5=$_GET["result5"];
                $date55=$_GET["date55"];
                $result55=$_GET["result55"];
