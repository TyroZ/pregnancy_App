            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Create appointment with the patient </p>
                </div>
                <div class="card-body">
                  <form  method="post" action="" enctype="multipart/form-data" >
                    <div class="row">
                        ...
                        <div class="form-group">
                          <label class="bmd-label-floating">APP_ID</label>
                          <input type="number" class="form-control" name="app_ID">
                        </div>
                      </div>
                      <div class="col-md-5">
                        <div class="form-group">
                          <label class="bmd-label-floating"> PATIENT_ID </label>
                          <input type="text" class="form-control" name="p_id">
                        </div>
                      </div>
                      <div class="col-md-3">
                        <div class="form-group">
                          <label class="bmd-label-floating">DOCTOR_ID </label>
                          <input type="number" class="form-control" name="d_id">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="bmd-label-floating">REASON </label>
                          <input type="email" class="form-control" name="reason">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">APP_DATE </label>
                          <input type="text" class="form-control" name="app_Date">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">START_TIME</label>
                          <input type="text" class="form-control" name="start_T">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" name="end_T">
                        </div>
                      </div>
                    </div>
                    <button type="submit" class="btn btn-primary pull-right">Set Appointment</button>
...
//Cleaning and sanitation of collected form data.
  ...
  $d_id = trim($d_id);
  $d_id = stripslashes($d_id);
  $d_id = htmlspecialchars($d_id);
  ...
  $app_Date = stripslashes($app_Date);
  $app_Date = htmlspecialchars($app_Date);

  $start_T = trim($start_T);
  $start_T = stripslashes($start_T);
  $start_T = htmlspecialchars($start_T);
  
    $end_T = trim($end_T);
  $end_T = stripslashes($end_T);
  $end_T = htmlspecialchars($end_T);
 ...
 if (empty($app_ID)) {
      ...
      $stmt = $conn->prepare("INSERT INTO APPOINTMENTS ( APP_ID, PATIENT_ID, DOCTOR_ID, REASON, APP_DATE , START_TIME, END_TIME )VALUES (?,?,?,?,?,?,?)");
      ...
      $stmt->bind_param("iiissss", $app_ID, $p_id, $d_id, $reason, $app_Date, $start_T, $end_T);//s means DBMS expect string datatype
      $app_ID = $app_ID;
      $p_id = $p_id;
      $d_id = $d_id;
      $reason = $reason;
