                ...
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> <?php
                        	...
                        	$connect = mysqli_connect("localhost", 'id9752012_pregnancybw', 'pregnancybw','id9752012_pregnancybw');    
                                ...
                                $due_date = mysqli_query($connect,"Select DUE_DATE From PATIENT WHERE P_ID=" . $txt);
	...
	if(isset($_GET['P_ID'])) {
		...
		$result = mysqli_query($connect,"SELECT * FROM PATIENT where P_ID=" . $txt); 
		    ...
		    echo " <form  method='post' enctype='multipart/form-data' action='updatePat.php'> ";
                    ...
                    echo " <div class='form-group'>";
                    echo "DUE DATE:<br>";  
                    echo " <input type='text' class='form-control' name='dueDate' value=" . $row['DUE_DATE'] . "> ";
                    echo " </div> ";
                    echo " </div> ";
                    echo " </div> ";
...
echo "<form  method='post' enctype='multipart/form-data' action='indexPAT.php'>";
                 ...
                 echo "<form  method='post' enctype='multipart/form-data' action='patientsAppointment.php'>";
                  echo " <div style='visibility:hidden' class='col-md-3'>";
                    echo "  <div class='form-group'> ";
                    echo "    <label class='bmd-label-floating'>PATIENT ID</label> ";
                    echo "    <input type='number' class='form-control' name='p_Id' value=" . $row['P_ID']. ">";
                    echo "   </div>";
                    echo " </div>";
                 echo "<button type='submit' class='btn btn-primary pull-right' > View Appointment </button>";
                 echo "</form>"; 
                 
                 
                 echo "<form  method='post' enctype='multipart/form-data' action='weeklyDisplay.php'>";
                  echo " <div style='visibility:hidden' class='col-md-3'>";
                    echo "  <div class='form-group'> ";
                    echo "    <label class='bmd-label-floating'>PATIENT ID</label> ";
                    echo "    <input type='number' class='form-control' name='p_ID' value=" . $row['P_ID']. ">";
                    echo "   </div>";
                    echo " </div>";
                 echo "<button type='submit' class='btn btn-primary pull-right' > View Weekly symptoms </button>";
                 echo "</form>"; 
