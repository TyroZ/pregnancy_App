          ...
          <div class="row">
              ...
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">ALL PATIENTS</p>
                  <h3 class="card-title">
                      	<?php
                        	//connect to db
              ...
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title"><?php
                        	//connect to db
                        	$connect = mysqli_connect("localhost", 'id9752012_pregnancybw', 'pregnancybw','id9752012_pregnancybw'); 
	                        	$size = "SELECT * , COUNT(P_ID) AS count from PATIENT WHERE P_ID IN (SELECT HIV_TESTING.P_ID from HIV_TESTING WHERE INITIAL_OUTCOME ='POSITIVE')";
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <p class="card-category"> First Trimester Patients</p>
                  <h3 class="card-title">+
<?php
                        	//connect to db
                        	$connect = mysqli_connect("localhost", 'id9752012_pregnancybw', 'pregnancybw','id9752012_pregnancybw'); 	
