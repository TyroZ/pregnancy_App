        ...
        $(document).ready(function () {
            ...
            function load_miscarriage_history(options,responsiveOptions) {
                ...
                $.post("getHistory.php",
                    ...
                    function(results){
                        msx = results.split('\n');
                        console.log('msx labels ==> '+ mapCoordinates(msx).labels.toString());
                        console.log('msx series ==> '+ mapCoordinates(msx).series.toString());
                        console.log('msx'+msx);
                        $.post("getHistory.php", {
                                'history': 'still_born_baby'
                            }, function (success) {
                                msx2 = success.split('\n');
                                console.log('msx2 labels ==> '+ mapCoordinates(msx2).labels.toString());
                                console.log('msx2 series ==> '+ mapCoordinates(msx2).series.toString());

                            console.log(mapSeries(msx2).toString());
                            let data = {
                                labels: labels,
                                series: [
                                    mapSeries(msx),
