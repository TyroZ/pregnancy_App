            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Here is a list of all set appointments</p>
                </div>
                 
                 
                <div class="card-body">
                       <a  href="createAppoint.php" >Create Appointments
                        </a>
	...
	$connect = mysqli_connect("localhost","id9752012_pregnancybw","pregnancybw","id9752012_pregnancybw");
		...
		if($result = mysqli_query($connect, $sql)){
		   ...
		   echo "<div class='card-body'>";
            ...
            echo "<td><a href='patientProfileForm.php?P_ID=" .  $row['PATIENT_ID'] . " '>  VIEW </a></td>"; 
