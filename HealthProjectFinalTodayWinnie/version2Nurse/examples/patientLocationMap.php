...
<script>
    ...
    function initMap() {
	    ...
	    $result = mysqli_query($connect,"SELECT LATITUDE FROM PATIENT where P_ID=" . $txt); 
	    $latitude = $result->fetch_assoc();
	    ...
	    $result1= mysqli_query($connect,"SELECT LONGITUDE FROM PATIENT where P_ID=" . $txt); 
	     $longitude = $result1->fetch_assoc();
