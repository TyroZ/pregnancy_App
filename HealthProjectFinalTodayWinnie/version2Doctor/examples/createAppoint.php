            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Add an appointment </p>
                </div>
                <div class="card-body">
                  <form  method="GET"  enctype="multipart/form-data" action="createAppoint.php" >
                    <div class="row">
                        <div class="col-md-7">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="datetime" class="form-control" name="start_T">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">END_TIME</label>
                          <input type="datetime" class="form-control" name="end_T">
                        </div>
                      </div>
                    </div>
...
//Cleaning and sanitation of collected form data.
 ...
 if (empty($app_ID)) {
      ...
      $stmt = $conn->prepare("INSERT INTO APPOINTMENTS (APP_ID, P_ID, DOCTOR_ID,REASON,APP_DATE,START_TIME,END_TIME )VALUES (?,?,?,?,?,?,?)");
