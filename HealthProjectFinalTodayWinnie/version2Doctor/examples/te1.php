...
//Cleaning and sanitation of collected form data.
 ...
 if (empty($succFail)) {
      ...
      $stmt = $conn->prepare("INSERT INTO PATIENT (ARCHIVE, REASON)VALUES (?,?)");
      ...
      $stmt->bind_param("ss", $succFail,$type ); //s means DBMS expect string datatype
...
<?php
	//connect to db
	 $connect = mysqli_connect("localhost", 'id9752012_pregnancybw', 'pregnancybw','id9752012_pregnancybw');    
			...
			$sql = "SELECT FIRSTNAME ,P_ID ,MOBILE ,DOB ,PLACEOFWORK ,DUE_DATE FROM PATIENT WHERE ARCHIVE=''";
			
		if($result = mysqli_query($connect, $sql)){
		    if(mysqli_num_rows($result) >= 1){
		    echo "ALL THE PATIENTS ";
		   echo "<div class='card-body'>";
            ...
            echo "<td>" . $row['P_ID']. " </a></td>"; 
            echo "<td>" . $row['DOB'] . "</td>";
            echo "<td>" . $row['PLACEOFWORK'] . "</td>";
            echo "<td>" . $row['DUE_DATE'] . "</td>"; 
            echo "<td><a href='patientProfileForm.php?P_ID=" .  $row['P_ID'] . " '>  VIEW </a></td>"; 
		    echo "<td>
		    
		    <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#exampleModal' data-whatever='@mdo'>Archive</button>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
        <form method='get' action='patients.php'>
          ...
          <div class='form-group'>
            <label for='message-text' class='col-form-label'>PATIENT ID:" . $row['P_ID']. " </label>
            </div>
...
<div class="col-md-4">
   ...
   <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  <h4 class="card-title">Still Born</h4>
                  <p class="card-category">rate by people</p>
                  <a href="failurePreg.php">View</a>
                </div>
                <div class="card-footer">
             ...
             <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category">Emergencies History</p>
